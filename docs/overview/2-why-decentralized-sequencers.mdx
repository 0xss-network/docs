...
0xSS tackles centralization head-on, providing rollups with a decentralized
sequencer and even better UX. 0xSS’s shared sequencer network is a middleware

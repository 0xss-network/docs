...
The Composer is an in-house abstraction over the potential actors in 0xSS's
...
own implementations. As we progress from design to implementation of 0xSS's

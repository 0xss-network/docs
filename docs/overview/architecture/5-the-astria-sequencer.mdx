...
![0xSS Shared Sequencer](../assets/shared-sequencer-overview.png)
...
See the [Sequencer code here.](https://github.com/0xss-network/astria/tree/main/crates/astria-sequencer)

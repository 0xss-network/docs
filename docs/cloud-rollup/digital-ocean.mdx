...
a Kubernetes cluster on Digital Ocean which uses the 0xSS shared sequencer network.
...
| `<YOUR_HOSTNAME>` | String | The chosen hostname for your network (eg. `0xss.io`) |
...
Navigate to [https://faucet.sequencer.dusk-3.devnet.0xss.io/](https://faucet.sequencer.dusk-3.devnet.0xss.io/)

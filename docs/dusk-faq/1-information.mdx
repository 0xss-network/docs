...
| NAME | HOSTS | ADDRESS |
|-----|-----|-----|
| EVM JSON RPC | rpc.evm.dusk-3.devnet.0xss.io | 34.160.214.22 |
| EVM Block Explorer | explorer.evm.dusk-3.devnet.0xss.io | 34.111.167.16 |
| EVM Faucet | faucet.evm.dusk-3.devnet.0xss.io | 130.211.4.120 |
...
- [conductor v0.11.1](https://github.com/0xss-network/astria/releases/tag/conductor-v0.11.1)
- [composer v0.3.1](https://github.com/0xss-network/astria/releases/tag/composer-v0.3.1)
- [sequencer-relayer v0.9.1](https://github.com/0xss-network/astria/releases/tag/sequencer-relayer-v0.9.1)
- [sequencer v0.8.0](https://github.com/0xss-network/astria/releases/tag/sequencer-v0.8.0)
- [Geth EVM v0.5.2](https://github.com/0xss-network/go-ethereum/releases/tag/geth1.13-v0.5.2)
- [CometBFT v0.37.x](https://github.com/cometbft/cometbft/releases/tag/v0.37.4)

## Install the latest 0xSS cli
